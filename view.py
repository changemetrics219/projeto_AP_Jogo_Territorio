            ...
            match opcao: 
                ...
                case "IJ": # iniciar jogo 
                    ...
                    if ij_n_jogador > 4 or ij_n_jogador < 2:
                        ...
                        j, contador = inicio_jogo(tabuleiro, lista_jogadores, j, ij_n_jogador, contador, coordenadasbonus, lin_alterar, col_alterar)
                        j = j + 1
                        ...
                        while True:  # Loop para tratamento de erros de input
                            ...
                            try:
                                ...
                                elif tabuleiro[lin_alterar][col_alterar] != "🔳" and tabuleiro[lin_alterar][col_alterar] != "⭐":
                                    print("Posição ocupada! Escolha outra.")
                                    continue # Volta para o início do loop while
                                atualizar_tabuleiro(tabuleiro, lin_alterar, col_alterar, lista_jogadores, j)
                                pass  
                                ...
                                if verificar_fim_de_jogo(lista_jogadores, tabuleiro, j, vizinhos) == True:  #RESOLVER COM JOOGADAS
                                 ...
                                 # Sai do loop while se o input for válido
